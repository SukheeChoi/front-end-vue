<template>
    ...
    <header class="headline-wrap">
        <h1 class="h1">표준단어</h1>
        <div>
            <button class="ow-btn type-state" @click="wPopup.show(true)">금칙어</button>
            <button class="ow-btn type-reference" @click="wPopup2.show(true)">조회</button>
        </div>
    </header>
    <!-- //header -->
    ...
    <div class="ow-grid">
        ...
        >
            ...
            <wj-flex-grid-column :header="'표준단어명'" :binding="'1'" :width="250" />
            <wj-flex-grid-column :header="'표준약어'" :binding="'2'" width="*" />
            <wj-flex-grid-column :header="'영문명'" :binding="'3'" :width="250" />
            <wj-flex-grid-column :header="'표준단어유형'" :binding="'4'" :width="100" />
            <wj-flex-grid-column :header="'최종수정자'" :binding="'5'" :width="150" />
            <wj-flex-grid-column :header="'최종수정일시'" :binding="'6'" :width="150" />
        </wj-flex-grid>
    </div>
    <!--// grid -->
    ...
    <div class="ow-grid">
        ...
        >
            ...
            <wj-flex-grid-column :header="'최종수정자'" :binding="'2'" :width="250" />
            <wj-flex-grid-column :header="'최종수정일시'" :binding="'3'" :width="250" />
        </wj-flex-grid>
    </div>
    <!--// grid2 -->
            ...
            <div class="layer-body">
                ...
                <div class="ow-grid mt-10">
                    ...
                    >
                        ...
                        <wj-flex-grid-column :header="'금칙어'" :binding="'1'" :width="150" />
                        <wj-flex-grid-column :header="'표준단어명'" :binding="'2'" :width="150" />
                        <wj-flex-grid-column :header="'표준약어'" :binding="'3'" width="*" />
                        <wj-flex-grid-column :header="'최종수정자'" :binding="'4'" :width="150" />
                        <wj-flex-grid-column :header="'최종수정일시'" :binding="'5'" :width="200" />
                    </wj-flex-grid>
                </div>
                <!--// grid -->
            </div>
            ...
            <div class="layer-body">
                ...
                <div class="ow-grid mt-10">
                    ...
                    >
                        ...
                        <wj-flex-grid-column :header="'표준단어유형'" :binding="'4'" :width="150" />
                        <wj-flex-grid-column :header="'최종수정자'" :binding="'5'" :width="100" />
                        <wj-flex-grid-column :header="'최종수정일시'" :binding="'6'" :width="200" />
                    </wj-flex-grid>
                </div>
                <!--// grid -->
            </div>
...
export default {
  ...
  data: function(){
    return {
      result: [
        { "1":"소득발생", "2":"ICOC", "3":"Income Occurrence", "4":"수식어", "5":"이강훈", "6":"2021-12-10 11:17"},
        { "1":"수령인", "2":"RECV", "3":"Receiver", "4":"수식어", "5":"이강훈", "6":"2021-12-09 09:10"},
        { "1":"일일이제", "2":"DATF", "3":"Daily Transfer To Account", "4":"수식어", "5":"이강훈", "6":"2021-12-01 12:17"},
        { "1":"가전제품", "2":"HMAP", "3":"Home Applications", "4":"수식어", "5":"이강훈", "6":"2021-12-05 13:20"},
        { "1":"직원", "2":"EMPL", "3":"Employee", "4":"수식어", "5":"이강훈", "6":"2021-12-10 11:17"},
      ],
      result2: [
        { "1":"소득발총", "2":"이강훈", "3":"2021-10-18 09:31"}
      ],
      result_popup: [
        { "checkboxColumn":"", "1":"CUSTOMER", "2":"고객", "3":"CUST", "4":"이강훈", "5":"2020-12-31 10:00"},
        { "checkboxColumn":"", "1":"EMAIL", "2":"이메일", "3":"EML", "4":"이강훈", "5":"2020-12-31 10:00"}
      ],
      result_popup2: [
        { "1":"소득발생", "2":"ICOC", "3":"Income Occurrence", "4":"수식어", "5":"이강훈", "6":"2021-12-10 11:17", "isCollapsed":false},
        { "1":"수령인", "2":"RECV", "3":"Receiver", "4":"수식어", "5":"이강훈", "6":"2021-12-09 09:10", "isCollapsed":false},
        { "1":"일일이제", "2":"DATF", "3":"Daily Transfer To Account", "4":"수식어", "5":"이강훈", "6":"2021-12-01 12:17", "isCollapsed":false},
        { "1":"가전제품", "2":"HMAP", "3":"Home Applications", "4":"수식어", "5":"이강훈", "6":"2021-12-05 13:20", "isCollapsed":false}
      ],
      isAllChecked:false,
      isChecked:false
    }
