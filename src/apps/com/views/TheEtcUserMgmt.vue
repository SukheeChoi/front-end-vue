  ...
  <div class="main-container">
    ...
    <div class="ow-grid">
      ...
      >
        ...
        <wj-flex-grid-column :header="'사번'" :binding="'field2'" width="*" />
        <wj-flex-grid-column :header="'이름'" :binding="'field3'" width="*" />
        <wj-flex-grid-column :header="'사용언어'" :binding="'field4'" width="*" />
        <wj-flex-grid-column :header="'부서'" :binding="'field5'" width="*" />
        <wj-flex-grid-column :header="'전화번호'" :binding="'field6'" width="*" />
        <wj-flex-grid-column :header="'이메일'" :binding="'field7'" width="*" />
        <wj-flex-grid-column :header="'최종로그인일시'" :binding="'field8'" width="*" />
        <wj-flex-grid-column :header="'상태'" :binding="'field9'" width="*" />
      </wj-flex-grid>
      ...
      <div v-show="currentTab == 1">
            ...
            <div class="col-3">
              ...
              <div class="datapicker-wrap">
                <div class="ow-input type-button">
                  <date-picker id="dateTimeInput1" v-model="date" :config="options"></date-picker>
                  <label for="dateTimeInput1" class="btn-calendar"></label>
                </div>
                <div class="mark">~</div>
                <div class="ow-input type-button">
                  <date-picker id="dateTimeInput2" v-model="date" :config="options"></date-picker>
                  <label for="dateTimeInput2" class="btn-calendar"></label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="ow-grid">
          <wj-flex-grid headersVisibility="Column" selectionMode="0" :itemsSource="resultTab2">
            ...
            <wj-flex-grid-column :header="'로그인일자'" :binding="'field2'" :width="250" />
            <wj-flex-grid-column :header="'IP주소'" :binding="'field3'" width="*" />
            <wj-flex-grid-column :header="'로그인일시'" :binding="'field4'" :width="250" />
            <wj-flex-grid-column :header="'로그아웃일시'" :binding="'field5'" :width="250" />
          </wj-flex-grid>
          <div class="ow-flex-wrap">
            <div class="item">
              <b-pagination
