<template>
  ...
  <div class="ow-grid">
    <wj-flex-grid :itemsSource="result" :isReadOnly="true" headersVisibility="Column">
      ...
      <wj-flex-grid-column :header="'번호'" :binding="'field0'" :width="70">
        <wj-flex-grid-cell-template cellType="Cell" v-slot="cell">
          {{ cell.row.index + 1 }}
        </wj-flex-grid-cell-template>
      </wj-flex-grid-column>
      <wj-flex-grid-column :header="'템플릿그룹ID'" :binding="'field1'" width="*" />
      <wj-flex-grid-column :header="'템플릿그룹명'" :binding="'field2'" width="*" />
      <wj-flex-grid-column :header="'템플릿그룹유형'" :binding="'field3'" width="*" />
      <wj-flex-grid-column :header="'사용여부'" :binding="'field4'" width="*" />
    ...
    <div v-show="currentTab == 0">
      ...
      <div class="ow-grid">
        <wj-flex-grid headersVisibility="Column" selectionMode="0" :itemsSource="result2">
          <wj-flex-grid-column :header="'템플릿그룹ID'" :binding="'field1'" width="*" />
          <wj-flex-grid-column :header="'템플릿그룹명'" :binding="'field2'" width="*" />
          <wj-flex-grid-column :header="'유형'" :binding="'field3'" width="*" />
          <wj-flex-grid-column :header="'메세지 제목'" :binding="'field4'" width="*" />
          <wj-flex-grid-column :header="'내용 형식'" :binding="'field5'" width="*" />
          <wj-flex-grid-column :header="'기본여부'" :binding="'field6'" width="*" />
          <wj-flex-grid-column :header="'사용여부'" :binding="'field7'" width="*" />
        </wj-flex-grid>
        <div class="ow-flex-wrap">
          <div class="item">
            <b-pagination
      ...
      <div class="layer-body">
        ...
        <table class="ow-table-type-info">
          ...
          <tr>
            ...
            <td>
              <div class="ow-radio">
                <input type="radio" id="ow-radio1" name="radio-group-3" checked />
                <label for="ow-radio1">Y</label>
              </div>
              <div class="ow-radio">
                <input type="radio" id="ow-radio2" name="radio-group-3" />
          ...
          <tr>
            ...
            <td>
              <div class="ow-radio">
                <input type="radio" id="ow-radio5" name="radio-group-1" checked />
                <label for="ow-radio5">HTML</label>
              </div>
              <div class="ow-radio">
                <input type="radio" id="ow-radio6" name="radio-group-1" />
            ...
            <td>
              <div class="ow-radio">
                <input type="radio" id="ow-radio3" name="radio-group-2" checked />
                <label for="ow-radio3">Y</label>
              </div>
              <div class="ow-radio">
                <input type="radio" id="ow-radio4" name="radio-group-2" />
