<template>
  <div class="main-container pd-10">
    ...
    <!-- grid -->
    <div class="ow-grid">
      <wj-flex-grid headersVisibility="Column" :selectionMode="'ListBox'" :itemsSource="result">
    ...
    <!-- grid2 -->
    <div class="ow-grid">
      <wj-flex-grid headersVisibility="Column" :selectionMode="'ListBox'" :isReadOnly="true" :itemsSource="result2">
        <wj-flex-grid-column :header="'번호'" :width="70">
          <wj-flex-grid-cell-template cellType="Cell" v-slot="cell">
            {{ cell.row.index + 1 }}
          </wj-flex-grid-cell-template>
    ...
    <div class="modal-body ow-scroll-wrap" style="height: 640px">
      <div class="layer-body">
        ...
        <div class="ow-grid mt-10">
          <wj-flex-grid headersVisibility="Column" :selectionMode="'ListBox'" :itemsSource="result_popup">
    ...
    <div class="modal-body ow-scroll-wrap" style="height: 640px">
      <div class="layer-body">
        ...
        <div class="ow-grid mt-10">
          ...
          >
            <wj-flex-grid-column :header="'checkboxColumn'" :binding="'checkboxColumn'" :width="50" checked="false">
              ...
              <wj-flex-grid-cell-template cellType="Cell" v-slot="cell">
                <input
                  ...
                  :id="cell.row.index + 1"
                  name="checkCol"
                  @click="clickFunc(cell.row.dataItem, $event)"
                />
              </wj-flex-grid-cell-template>
            </wj-flex-grid-column>
            <!-- <ow-flex-grid-check-column></ow-flex-grid-check-column> -->
...
export default {
  ...
  methods: {
    ...
    allCheck(data, event) {
      ...
      this.checkedValues = [];
      if (isChecked) {
        this.checkedValues.push(...data.items);
      }
    },
