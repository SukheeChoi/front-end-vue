<template>
  ...
  <div class="ow-grid mt-10">
    <wj-flex-grid headersVisibility="Column" :selectionMode="'ListBox'" :itemsSource="result">
      ...
      <!-- select 삽입 -->
      <wj-flex-grid-column :header="'번들'" :binding="'field2'" :width="200" />

      <wj-flex-grid-column :header="'언어'" :binding="'field3'" :width="'*'" />
      <wj-flex-grid-column :header="'메세지 키'" :binding="'field4'" :width="'*'" />
      <wj-flex-grid-column :header="'메세지 실행'" :binding="'field5'" :width="'*'" />
      <wj-flex-grid-column :header="'최종 업데이트 일자'" :binding="'field6'" :width="'*'">
      ...
      <div class="layer-body">
        ...
        <div class="ow-grid mt-10">
          <wj-flex-grid headersVisibility="Column" :selectionMode="'ListBox'" :itemsSource="resultPop">
            ...
            <wj-flex-grid-column :header="'번들'" :binding="'field2'" :width="70" />
            <wj-flex-grid-column :header="'언어'" :binding="'field3'" :width="70" />
            <wj-flex-grid-column :header="'메세지 키'" :binding="'field4'" :width="200" />
            <wj-flex-grid-column :header="'메세지 설명'" :binding="'field5'" :width="200" />
            <wj-flex-grid-column :header="'에러 여부'" :binding="'field6'" :width="200" />
            <wj-flex-grid-column :header="'에러 메세지'" :binding="'field7'" :width="200" />
          </wj-flex-grid>
        </div>
        <!--// grid -->
      </div>
